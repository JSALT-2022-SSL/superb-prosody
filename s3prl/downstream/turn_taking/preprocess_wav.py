...
def get_preprocess_args():
    ...
    parser.add_argument('-i', '--input_path', default='./Data/', type=str, help='Path to your LibriSpeech directory', required=False)
...
def split_and_save(input_file, current_split, args):
    ...
    for i, w in enumerate(splitted_wav):
        ...
        w = F.pad(input=w, pad=(0, chunk_size - w.size(1), 0, 0), mode='constant', value=0)
